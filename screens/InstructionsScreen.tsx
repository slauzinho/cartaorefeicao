...
const EdenRedInstructions = () => (
  <View>
    <Card>
      <Text>
        Recentemente a Edenred mudou a forma de consulta dos seus cartões.
      </Text>
      <Text>
        Atualmente para consultares o saldo tens de criar conta no site da
        Edenred ou na aplicação Edenred.
      </Text>
    </Card>
    <Card>
      <Text>
        Se ainda não tens registo feito deves criar conta em
        https://myedenred.pt
      </Text>
    </Card>
    <Card>
    ...
    <Card>
      <Text>
        Na nossa aplicação basta colocares o email que usaste para o registo,
        password e o número do cartão que associaste.
      </Text>
    </Card>
    <Card>

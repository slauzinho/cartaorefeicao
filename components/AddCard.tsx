...
import { StyleSheet, Text, View, Image, Picker, TouchableOpacity, ScrollView } from 'react-native';
...
const AddCard: FunctionComponent<NavigationInjectedProps> = props => {
    ...
    const onSubmit = async ({ cardNumber, cardPassword, tipo, cardName, cardColor, email }: Card, actions) => {
        if (isNumeric(cardNumber) && isNumeric(cardPassword) && tipo === 'santander') {
            try {
    ...
    return (
        <View style={{ flex: 1, paddingTop: 15 }}>
            <ScrollView>
                            ...
                            {message ? (
                                ...
                                >
                                    ...
                                    <Text style={{ color: 'red' }}>
                                        Se estiveres com dificuldades a adicionar um cartão consulta as instruções
                                        através do icon no topo superior direito
                                    </Text>
                                </View>
                            ) : null}
                            <Button
                ...
                >
                    <Image source={require('../assets/images/example.png')} resizeMode="contain" />
